...
const candidate = {
  ...
  current_city: "Tokyo",
  japan_residency_status: "resident",
  japan_work_authorization: true,
  ...
  full_time_interest: true,
  freelance_interest: false,
  earliest_start_date: null,
  hiring_readiness_status: "A",
  hiring_readiness_confidence: 90,
  hiring_readiness_evidence: "Human verified",
  hiring_readiness_verified_at: "2026-07-14T00:00:00.000Z",
  readiness_verification: { japan_work_authorization: "verified" },
  ...
  outreach_review_status: "not_requested",
  notes: null,
  image_path: null,
  work_image_count: 0,
  data_quality_score: 85,
  data_quality_missing: ["portfolio_images"],
